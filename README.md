...
«15.1 Магические методы», «16.1 Наследование» и «16.2 Множественное наследование».
...
- `feature/homework-16-1` — выполненное задание 16.1;
- `feature/homework-16-2` — полностью выполненное задание 16.2.

Для сдачи работы нужно создать Pull Request из `feature/homework-16-2` в `develop`.
