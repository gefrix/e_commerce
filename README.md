...
Проект последовательно развивается в домашних заданиях SkyPro «14.1 Введение в ООП» и «14.2 Режимы доступа».
...
Дополнительные задания с загрузкой данных из `products.json`, объединением дубликатов и подтверждением снижения цены
также выполнены.
...
- `feature/homework-14-2` — полностью выполненное задание 14.2.

Для сдачи работы нужно создать Pull Request из `feature/homework-14-2` в `develop`.
